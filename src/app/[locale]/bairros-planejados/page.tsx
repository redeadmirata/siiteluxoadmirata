...
const BAIRROS_FALLBACK = [
  {
    ...
    introTexto: 'O bairro planejado mais moderno do Rio — parque com 72 mil m², segurança 24h e uma curadoria de condomínios de altíssimo padrão.',
    totalCondominios: 7,
    totalImoveis: 0,
  },
  {
    ...
    introTexto: 'Complexo residencial de luxo com área de lazer de 75 mil m², frente ao Canal de Marapendi na Barra da Tijuca.',
    totalCondominios: 12,
    totalImoveis: 0,
  },
  {
    ...
    regiao: 'Barra da Tijuca',
    incorporadora: 'Odebrecht Realizações',
    introTexto: 'Bairro planejado integrado ao shopping RioSul na Barra, com infraestrutura completa e localização estratégica.',
    totalCondominios: 8,
    totalImoveis: 0,
  },
  {
  ...
  },
  {
    ...
    regiao: 'Recreio dos Bandeirantes',
    incorporadora: 'Carvalho Hosken',
    introTexto: 'Bairro planejado sustentável no Recreio com foco em natureza, trilhas e qualidade de vida contemporânea.',
    totalCondominios: 4,
    totalImoveis: 0,
  },
  {
    ...
    cidade: 'Rio de Janeiro',
    regiao: 'Zona Oeste',
    incorporadora: 'Múltiplas incorporadoras',
    introTexto: 'Zona em expansão com loteamentos planejados e crescente oferta de casas e condomínios horizontais de alto padrão.',
    totalCondominios: 5,
    totalImoveis: 0,
  },
]
...
export async function generateMetadata({
  ...
  return {
    title: 'Bairros Planejados no Rio de Janeiro | Ilha Pura, Península, Rio2 — Admirata',
    description:
      'Conheça os principais bairros planejados do Rio de Janeiro: Ilha Pura, Península, Rio2, Pontal Oceânico, Mandala e mais. Imóveis de alto padrão com curadoria Admirata.',
    alternates: {
      canonical: `${siteUrl}${localePrefix}/bairros-planejados`,
    },
    openGraph: {
      title: 'Bairros Planejados no Rio de Janeiro — Admirata',
      description: 'Os melhores bairros planejados do Rio: Ilha Pura, Península, Rio2, Pontal Oceânico e Mandala.',
      type: 'website',
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Os principais bairros planejados do Rio de Janeiro: Ilha Pura, Península, Rio2, Pontal Oceânico e Mandala',
        url: `${siteUrl}${localePrefix}/bairros-planejados`,
      },
    ],
  }
