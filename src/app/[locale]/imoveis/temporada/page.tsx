/**
 * /imoveis/temporada
 * Faceted URL — finalidade 'Temporada' fixada na rota
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: 'Imóveis para Temporada — Rio de Janeiro e Serra Gaúcha | Admirata',
    description:
      'Aluguel por temporada de alto padrão no Rio de Janeiro e Serra Gaúcha. Coberturas, apartamentos e casas — Admirata Imóveis.',
    alternates: { canonical: `${siteUrl}/imoveis/temporada` },
    openGraph: {
      title: 'Imóveis para Temporada | Admirata',
      description: 'Temporada de luxo no Rio de Janeiro e Serra Gaúcha.',
      type: 'website',
    },
  }
}
...
export default async function ImoveisTemporadaPage({ params, searchParams }: PageProps) {
