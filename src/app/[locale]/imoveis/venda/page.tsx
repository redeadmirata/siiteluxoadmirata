/**
 * /imoveis/venda
 * Faceted URL — indexável, SEO limpo, finalidade fixada na rota
 */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: 'Imóveis à Venda — Barra da Tijuca, Recreio e Leblon | Admirata',
    description:
      'Coberturas, apartamentos e casas de luxo à venda no Rio de Janeiro e Serra Gaúcha. Curadoria exclusiva Admirata Imóveis.',
    alternates: { canonical: `${siteUrl}/imoveis/venda` },
    openGraph: {
      title: 'Imóveis à Venda | Admirata',
      description: 'Alto padrão redefinido. Portfólio exclusivo no Rio de Janeiro e Serra Gaúcha.',
      type: 'website',
    },
  }
}
...
export default async function ImoveisVendaPage({ params, searchParams }: PageProps) {
