...
export default function WhatsAppButton({
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span
        className={`hidden sm:block text-[11px] tracking-wide bg-ink text-white px-3 py-1.5 rounded-sm
      ...
      {/* Botão */}
      <div
        className="w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-black/20
