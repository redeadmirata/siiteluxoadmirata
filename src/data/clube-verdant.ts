...
export const clubeVerdant: ClubeData = {
  ...
  hero: {
    ...
    subtitulo:
      'Mais de 19.000 m² de lazer, esporte e bem-estar — um resort privativo a poucos passos de casa.',
    imagem: '/images/clube-verdant/hero.jpg',
    imagemAlt:
      'Clube Verdant — estrutura de lazer do condomínio Grand Club Verdant em Jacarepaguá',
  ...
  intro: {
    titulo: 'Clube Verdant',
    paragrafos: [
      'O Clube Verdant é o coração do condomínio Grand Club Verdant.',
  ...
  programacao: [
    {
      ...
      atividades: [
        { nome: 'Natação', turmas: ['Bebês (0 a 2 anos)', '3 a 5 anos', '6 a 8 anos', '9 a 13 anos', 'Adulto'], keyword: 'condomínio com aulas de natação' },
    ...
    },
    {
      ...
      atividades: [
        { nome: 'Futebol', turmas: ['Infantil (4 a 6 anos)', 'Teen (7 a 13 anos)'], keyword: 'condomínio com futebol infantil' },
        { nome: 'Futvôlei', turmas: ['Adulto'] },
        { nome: 'Vôlei', turmas: ['Teen', 'Adulto'], keyword: 'condomínio com vôlei' },
        { nome: 'Beach Tênis', turmas: ['Iniciante', 'Intermediária'], keyword: 'condomínio com beach tennis' },
      ],
    },
    {
      id: 'artes-marciais',
    ...
    },
    {
      ...
      descricao:
        'Aulas de dança e ballet para diferentes públicos, do baby class ao adulto.',
      atividades: [
        { nome: 'Dance Mix', turmas: ['Kids', 'Adulto'], keyword: 'condomínio com dança' },
        { nome: 'Dança de Salão', turmas: ['Adulto'] },
        { nome: 'Ballet', turmas: ['Baby Class (3 a 6 anos)', 'Preliminar (7 a 12 anos)'], keyword: 'condomínio com ballet infantil' },
      ],
    },
  ],
